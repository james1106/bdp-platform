...
public class ValidateCodeController {
	...
	public ValidateCode generate(HttpServletRequest request) {
		int width = ServletRequestUtils.getIntParameter(request, "width", 65);
		int height = ServletRequestUtils.getIntParameter(request, "height", 30);
		...
		return new ValidateCode(image, sRand, 60);
	}
