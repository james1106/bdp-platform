...
// 注意：上面两行的配置与下面这一行配置是等价的，这里使用下面这种方式是为了@EnableBdpAuthClient共用AuthClientAutoConfig，代码一致些
...
// 注意此处Auto-configuration配置特指通过spring.factories加载的配置，这种是"真的"自动配置，通过@EnableResourceServer类似的配置是人为干预了，不是"真的"自动配置。<br/>
